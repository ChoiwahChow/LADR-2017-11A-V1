...
void usage_message(FILE *fp, Mace_options opt)
{
  ...
  "  -A n : (upper case) flag print_models_gap (%s).\n"
  ...
  "\n"
	  ...
	  flag(opt->print_models_gap) ? "set" : "clear",
			       ...
			       Mace_options opt)
{
  ...
  */
  ...
  while ((c = getopt(argc, argv,
	     "n:N:m:t:s:b:O:M:p:P:v:L:G:H:I:J:K:T:R:i:q:Q:S:cf:g:A")) != EOF) {
    switch (c) {
    case 'n':
    ...
    case 'p':
      ...
      break;
    case 'A':
      command_line_flag(opt->print_models_gap, optarg);
      break;
